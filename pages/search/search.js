...
Page({
    ...
    async getInitData() {
        ...
        this.setData({
            placeholderContent: placehoderData.data.showKeyword,
    ...
    // 点击搜索历史,把搜索内容替换为该历史
    changeInputByHistory(event) {
        console.log(event)
        let searchContent = event.currentTarget.dataset.item
        this.setData({
            searchContent
        })
        this.getSearchList()
